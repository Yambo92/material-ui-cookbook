...
const fetchPanelContent = index => 
    new Promise(resolve => 
        ...
        export default function LazyLoadingPanelContent() {
            ...
            /* The second argument passed to this function,  expanded , tells you whether or
not the panel is expanding. If this value is false, you know that the panel is
collapsed and that the API call shouldn't be made. This condition has been
added to look for content that has already been loaded for the panel */
